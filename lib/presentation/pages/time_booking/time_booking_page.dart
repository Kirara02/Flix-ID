...
class _TimeBookingPageState extends ConsumerState<TimeBookingPage> {
  final List<String> theaters = ['XXI the Botanica', 'XXI Cihampelas Walk', 'CGV Paris van Java', 'CGV Paskal23'];
          ...
          Column(
            ...
            children: [
              ...
              ...options(
                ...
                isOptionEnable: (hour) =>
                    selectedDate != null &&
                    DateTime(selectedDate!.year, selectedDate!.month, selectedDate!.day, hour).isAfter(DateTime.now()),
                onTap: (object) => setState(() {
                  selectedHour = object;
                }),
              ),
              Padding(
                ...
                child: SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: () {
                          if (selectedDate == null || selectedHour == null || selectedTheater == null) {
                            ...
                            ref
                                .read(routerProvider)
                                .pushNamed('seat-booking', extra: (widget.movieDetail, transaction));
                          }
                        },
