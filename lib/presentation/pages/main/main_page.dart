...
import 'package:flix_id/presentation/pages/movie/movie_page.dart';
import 'package:flix_id/presentation/pages/profile/profile_page.dart';
import 'package:flix_id/presentation/pages/ticket/ticket_page.dart';
...
class _MainPageState extends ConsumerState<MainPage> {
  ...
  void initState() {
    ...
    if (widget.imageFile != null && user != null) {
      ref.read(userDataProvider.notifier).uploadProfilePicture(user: user, imageFile: widget.imageFile!);
    }
  }
